  ...
  return (
    <div className='w-[90%] flex flex-col justify-center items-center bg-black text-white '>
        <div className='flex w-full h-full justify-around items-center'>
            <textarea value={query} className='w-[85%] h-[90%] p-2 overflow-y-scroll rounded-lg' name="query" id="" placeholder='Enter your question here..' onChange={e => setQuery(e.target.value)}></textarea>
